...
async def get_mockup_data(DDMM):
    ...
    print(date, month)
    url = 'https://api-v3.thaiwater.net/api/v1/thaiwater30/public/waterlevel_graph?station_type=tele_waterlevel&station_id=2752&start_date=2023-'+str(last_month)+'-'+str(date)+'&end_date=2023-'+str(next_month)+'-'+str(date)+'%2023:59'
